...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      <div
        className={cn(
          "rounded-3xl border bg-gradient-to-b from-sky-50 to-white p-8 shadow-sm",
        )}
      >
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          <div className="flex size-8 items-center justify-center rounded-full bg-sky-50 text-sky-500">
      ...
      <div className="mt-6 rounded-2xl border bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 flex items-center gap-2 rounded-xl border border-sky-200 bg-sky-50 px-4 py-3">
